...
from unified_planning.shortcuts import InstantaneousAction, Fluent, FNode #type: ignore
...
class ModifiedProblemInfo:
    ...
    def __init__(
        ...
        self.action_to_left_precondition_mapping: dict[str, tuple[InstantaneousAction, list[FNode]]] = action_to_left_precondition_mapping
...
class ModifiedPlanInformation():
    ...
    def __init__(
        ...
        self.left_preconditions: dict[str, tuple[InstantaneousAction, list[FNode]]] = left_preconditions
